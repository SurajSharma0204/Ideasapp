...
ideas = {
    ...
    2: {
        "id" : 2,
        "idea_name" : "Save Soil",
        "idea_description" : "Details about ave Soil", 
        "idea_author" : "Sharma"
...
#Create an RESTful endpoint for creating a new idea 
...
def create_idea():
    ...
    try :
        ...
        #Insert the passed idea in the ideas dictrionary
        ideas[request_body["id"]] = request_body

        #Return the response saying idea got saved
        return "idea is created and saved successfully", 201
    except KeyError :
